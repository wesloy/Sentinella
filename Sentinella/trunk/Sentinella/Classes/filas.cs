...
namespace Sentinella {
    ...
    //	    [arqExterno]           BIT            DEFAULT ((0)) NOT NULL,
    ...
    class filas {
        ...
        private bool _ativo, _arqExterno;
        ...
        private bool _incluir(filas obj) {
            try {
                ...
                sql += objCon.valorSql(obj.ArqExterno) + ",";
        ...
        private bool _atualizar(filas obj) {
            try {
                ...
                sql += "ArqExterno = " + objCon.valorSql(obj.ArqExterno) + ",";
            ...
            try {
                ...
                if (dt.Rows.Count > 0) {
                    foreach (DataRow ln in dt.Rows) {
                        ...
                        oDados.ArqExterno = bool.Parse(ln["ArqExterno"].ToString());
        ...
        public ListView CarregaListView(ListView lst, string filtro = "") {
            try {
                ...
                lst.Columns.Add("ARQ. EXTERNO", 80, HorizontalAlignment.Left);
